// Gull Run Evo — stage-specific evolution foods, shared across every stage.
const FOOD_SETS=[['hotdog','burger','pizza'],['pizza','hotdog','burger'],['sausageRoll','meatPie','avocadoToast'],['croissant','macaron','baguette'],['gelato','pasta','cannoli'],['cheese','chocolate','bread'],['pretzel','bratwurst','chicken'],['tea','scone','fishChips'],['onigiri','sushi','ramen'],['dates','baklava','shawarma'],['dumpling','bao','noodles'],['dates','fig','teaGlass'],['banana','pineapple','acai'],['taco','avocado','smoothie']];
...
const FOOD_ATLAS=new Image();FOOD_ATLAS.src='food-atlas.webp';const C=100;
